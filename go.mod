...
// for local development, you should `git clone -b feat/proxy git@github.com:warjiang/image.git`
// after use go mod instruction, you should execute the following cmd
// go mod tidy && go mod vendor
replace github.com/containers/image/v5 => /Users/warjiang/workspace/opensource/image
